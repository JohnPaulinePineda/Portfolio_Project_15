...
|
| [T-Test P-Values](https://www.jstor.org/stable/2685564?seq=1#page_scan_tab_contents) define the probability of obtaining an effect during hypothesis testing, at least as large as the one actually observed in the sample data, specifically assuming that the null hypothesis is true. For a T-Test, the means of a numeric variable are evaluated between two categories if they significantly differ from each another. 
|
